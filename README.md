#  Human & Car Detection System
###  Phase 2 Technical Assessment (AI/ML)
...
| Task 04 | BoT-SORT object tracking attempted (bonus) — VisDrone model and COCO yolov8x both tried; SAHI detection proved more effective for drone footage |
